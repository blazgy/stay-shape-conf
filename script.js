...
const content = {
  ...
  de: {
    ...
    nav: {
      overview: "Herausforderung",
      context: "Strategie",
      programme: "Programm",
      register: "Anmeldung",
    },
    hero: {
      eyebrow: "Stay & Shape Konferenz 2026",
      kicker: "Konferenz 2026",
      title:
        "Stay & Shape: Jugend, Migration und die digitale Transformation der Arbeit in Südosteuropa",
      lead:
        "Junge Arbeitnehmer:innen stärken. Die digitale Zukunft regulieren. Gründe zum Bleiben schaffen.",
      ctaPrimary: "Mitmachen",
      ctaSecondary: "Programm ansehen",
      panelLabel: "Fortschritt gestalten",
      panelNote:
        "Organisiert in Partnerschaft mit dem Österreichischen Gewerkschaftsbund (ÖGB), Internationales Referat, und der Friedrich-Ebert-Stiftung (FES).",
      facts: [
        {
          label: "Teil 1",
          value: "Wien, Österreich | 18.-19. Juni 2026",
        },
        {
          label: "Teil 2",
          value: "Sarajevo, Bosnien und Herzegowina | 22.-23. Oktober 2026",
        },
      ],
    },
    overview: {
      eyebrow: "Die Herausforderung",
      titleLine1: "Eine Arbeitswelt",
      titleLine2: "im Umbruch",
      copyA:
        "In Südosteuropa verlassen immer mehr junge Menschen ihre Heimatländer, getrieben von niedrigen Löhnen und unsicheren Beschäftigungsverhältnissen.",
      copyB:
        "Während traditionelle Branchen nicht mehr jene Sicherheit bieten, die sie früher versprachen, verändert die rasante Digitalisierung - von künstlicher Intelligenz bis zu algorithmischem Management - die Arbeit derjenigen grundlegend, die bleiben.",
      bridge: "Diese doppelte Transformation bringt komplexe Herausforderungen mit sich:",
      threatTitle: "Das Risiko",
      threatCopy:
        "Automatisierung von Jobs, zunehmende Überwachung am Arbeitsplatz und wachsende wirtschaftliche Ungleichheiten.",
      opportunityTitle: "Die Chance",
      opportunityCopy:
        "Neue Technologien nutzen, um bessere, sicherere und flexiblere Arbeitsumfelder zu schaffen.",
      bottomLine:
        "Für eine faire Zukunft müssen wir die wirtschaftlichen Ursachen von Abwanderung angehen und die digitale Transformation so gestalten, dass sie Arbeitnehmer:innen aktiv zugutekommt.",
      mediaLabel: "Systemanalyse",
    },
    context: {
      eyebrow: "Strategie",
      objectiveLabel: "Unser Ziel",
      titleLine1: "Macht aufbauen.",
      titleLine2: "Systeme gestalten.",
      titleLine3: "Gründe zum Bleiben schaffen.",
      copyA:
      ...
      shareTitle: "Teilen",
      shareCopy:
        "Praktische Strategien für Jugendansprache und institutionelle Stärkung.",
      developTitle: "Entwickeln",
      developCopy:
        "Konkrete Initiativen, die jungen Menschen überzeugende wirtschaftliche Gründe geben, in ihren Heimatländern zu bleiben.",
      formulateTitle: "Formulieren",
      formulateCopy:
        "Politiken, die faire Arbeitsstandards über Grenzen hinweg sichern und dafür sorgen, dass Technologie Arbeitnehmer:innen dient - nicht nur Algorithmen.",
      bottomLineA: "Von der Analyse",
      bottomLineB: "zur Handlung.",
    },
    objectives: {
      eyebrow: "Ziele",
    ...
    programme: {
      eyebrow: "Wien",
      series: "Stay & Shape Konferenzreihe 2026",
      city: "Wien",
      title: "\"Power & Participation\"",
      ...
      stamp: "Handeln durch Solidarität",
      panelRail: "Hochrangiges Panel",
      panelTitle: "Der algorithmische Boss?",
      panelCopy:
        "Wie KI und Automatisierung Jugendbeschäftigung, Arbeitsqualität und Arbeitnehmer:innenrechte verändern.",
      panelFormat:
        "Format: 30-minütige Expert:innen-Keynote gefolgt von einer hochrangigen Paneldiskussion.",
      ...
      panelistKnut: "Martin Gruber-Risak",
      panelistKnutRole:
        "Leiter der Sektion VIII Arbeitsrecht und Arbeitnehmer:innenschutz im Sozialministerium",
      panelistAmelie: "Amelie Muthsam",
      panelistAmelieRole:
    ...
    sarajevo: {
      eyebrow: "Ausblick",
      series: "Teil 2 Spotlight",
      city: "Sarajevo",
      title: "\"Migration & Mobilität\"",
